...
PRODUCT_COPY_FILES += \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_Center_P3.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_Center_P3.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_Center_sRGB.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_Center_sRGB.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_Enhance_P3.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_Enhance_P3.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_Enhance_sRGB.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_Enhance_sRGB.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_Stand_P3.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_Stand_P3.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_Stand_sRGB.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_Stand_sRGB.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_StandardMode_P3.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_StandardMode_P3.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/PanelChaplin/3D-Lut_StandardMode_sRGB.txt:$(TARGET_COPY_OUT_ODM)/etc/PanelChaplin/3D-Lut_StandardMode_sRGB.txt \
    ...
    vendor/oneplus/lexus/proprietary/odm/etc/display/qdcm_calib_data_AA592_P_7_A0014_dsc_cmd_mode_panel.json:$(TARGET_COPY_OUT_ODM)/etc/display/qdcm_calib_data_AA592_P_7_A0014_dsc_cmd_mode_panel.json \
    ...
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_2mic_calibration.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_2mic_calibration.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID10_MIC_VR.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID10_MIC_VR.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID10_MIC_VR.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID10_MIC_VR.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID11_HE.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID11_HE.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID11_HE.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID11_HE.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID12_HE_App1.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID12_HE_App1.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID12_HE_App1.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID12_HE_App1.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID13_HE_App2.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID13_HE_App2.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID13_HE_App2.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID13_HE_App2.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID14_HE_Cam.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID14_HE_Cam.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID14_HE_Cam.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID14_HE_Cam.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID15_HE_Conference.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID15_HE_Conference.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID15_HE_Conference.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID15_HE_Conference.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID16_HE_Fast.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID16_HE_Fast.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID16_HE_Fast.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID16_HE_Fast.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID17_HE_Interview.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID17_HE_Interview.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID17_HE_Interview.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID17_HE_Interview.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID18_HE_Unprocess.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID18_HE_Unprocess.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID18_HE_Unprocess.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID18_HE_Unprocess.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID19_HE_Voice.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID19_HE_Voice.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID19_HE_Voice.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID19_HE_Voice.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID1_MIC_normal.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID1_MIC_normal.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID1_MIC_normal.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID1_MIC_normal.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID20_HE_VR.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID20_HE_VR.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID20_HE_VR.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID20_HE_VR.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID21_HE_USB.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID21_HE_USB.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID21_HE_USB.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID21_HE_USB.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID22_HE_App1_USB.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID22_HE_App1_USB.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID22_HE_App1_USB.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID22_HE_App1_USB.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID23_BT_NORMAL.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID23_BT_NORMAL.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID23_BT_NORMAL.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID23_BT_NORMAL.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID24_BT_APP1.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID24_BT_APP1.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID24_BT_APP1.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID24_BT_APP1.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID25_ZOOM.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID25_ZOOM.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID25_ZOOM.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID25_ZOOM.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID26_Concert.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID26_Concert.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID26_Concert.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID26_Concert.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID2_MIC_App1.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID2_MIC_App1.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID2_MIC_App1.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID2_MIC_App1.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID3_MIC_App2.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID3_MIC_App2.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID3_MIC_App2.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID3_MIC_App2.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID4_MIC_Cam.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID4_MIC_Cam.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID4_MIC_Cam.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID4_MIC_Cam.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID5_MIC_Conference.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID5_MIC_Conference.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID5_MIC_Conference.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID5_MIC_Conference.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID6_MIC_Fast.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID6_MIC_Fast.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID6_MIC_Fast.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID6_MIC_Fast.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID7_MIC_Interview.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID7_MIC_Interview.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID7_MIC_Interview.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID7_MIC_Interview.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID8_MIC_Unprocess.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID8_MIC_Unprocess.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID8_MIC_Unprocess.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID8_MIC_Unprocess.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID99_Bypass.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID99_Bypass.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID99_Bypass.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID99_Bypass.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID9_MIC_Voice.bin:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID9_MIC_Voice.bin \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID9_MIC_Voice.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/2mic/oprec_audrec_parameter_2mic_ID9_MIC_Voice.txt \
    vendor/oneplus/lexus/proprietary/odm/etc/oprec_audrec_params/oprec_audrec_config.txt:$(TARGET_COPY_OUT_ODM)/etc/oprec_audrec_params/oprec_audrec_config.txt \
    ...
    vendor/oneplus/lexus/proprietary/odm/vendor/etc/wifi/WCNSS_qcom_cfg.ini:$(TARGET_COPY_OUT_ODM)/vendor/etc/wifi/WCNSS_qcom_cfg.ini \
    ...
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b00:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b00 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b01:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b01 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b02:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b02 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b03:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b03 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b04:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b04 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b05:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b05 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b06:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b06 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b07:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b07 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.b08:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.b08 \
    vendor/oneplus/lexus/proprietary/odm/vendor/firmware/antdtx.mdt:$(TARGET_COPY_OUT_ODM)/vendor/firmware/antdtx.mdt \
    ...
    vendor/oneplus/lexus/proprietary/vendor/firmware/sn220u.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/sn220u.bin \
